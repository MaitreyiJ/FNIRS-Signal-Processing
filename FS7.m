...
ch10=d(:,10);%data from long-distance channel 4-2
figure,plot(t,ch10,'g');
hold on;
plot(t,ch12,'r');
...
dc10=dc( :,10);
figure,plot(dc10);%ploting concentration data from channel 5 after processing.
...
dod10Old=dod( :,10);
dod10New=filteredData;
figure,plot(t,dod10Old);
hold on 
plot(t,dod10New);
