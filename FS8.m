...
ch12=d(:,12);%data from short-distance channel 4-4
ch11=d(:,11);%data from long-distance channel 4-3
figure,plot(t,ch11,'g');
hold on;
plot(t,ch12,'r');
...
dc11=dc( :,11);
figure,plot(dc11);%ploting concentration data from channel 5 after processing.
...
dod11Old=dod( :,11);
dod11New=filteredData;
figure,plot(t,dod11Old);
hold on 
plot(t,dod11New);
