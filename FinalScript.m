...
ch2=d(:,2);%data from long- distance channel 1-2
...
dc2=dc( :,5);
figure,plot(dc2);%ploting concentration data from channel 5 after processing.
...
dod2Old=dod( :,2);
dod2New=filteredData;
figure,plot(t,dod2Old);
hold on 
plot(t,dod2New);
