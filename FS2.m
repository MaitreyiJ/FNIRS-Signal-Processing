...
%data from left hemisphere
ch1=d(:,1);%data from short-distance channel 1-1
ch3=d(:,3);%data from long-distance channel  1-3
figure,plot(t,ch3,'g');
hold on;
plot(t,ch1,'r');
...
dc3=dc( :,3);
figure,plot(dc3);%ploting concentration data from channel 5 after processing.
...
dod3Old=dod( :,3);
dod3New=filteredData;
figure,plot(t,dod3Old);
hold on 
plot(t,dod3New);
