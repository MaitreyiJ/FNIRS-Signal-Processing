...
ch5=d(:,5);%data from long-distance channel  2-3
ch6=d(:,6);%data from short-distance channel 2-4
figure,plot(t,ch5,'g');
hold on;
plot(t,ch6,'r');
...
dc5=dc( :,5);
figure,plot(dc5);%ploting concentration data from channel 5 after processing.
...
dod5Old=dod( :,5);
dod5New=filteredData;
figure,plot(t,dod5Old);
hold on 
plot(t,dod5New);
