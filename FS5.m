...
ch8=d(:,8);%data from long-distance channel 3-2
figure,plot(t,ch8,'g');
hold on;
plot(t,ch7,'r');
...
dc8=dc( :,8);
figure,plot(dc8);%ploting concentration data from channel 5 after processing.
...
dod8Old=dod( :,8);
dod8New=filteredData;
figure,plot(t,dod8Old);
hold on 
plot(t,dod8New);
