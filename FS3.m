...
ch4=d(:,4);%data from long-distance channel  2-2
...
dc4=dc( :,4);
figure,plot(dc4);%ploting concentration data from channel 5 after processing.
...
dod4Old=dod( :,4);
dod4New=filteredData;
figure,plot(t,dod4Old);
hold on 
plot(t,dod4New);
